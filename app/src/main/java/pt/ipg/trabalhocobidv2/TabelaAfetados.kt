...
class TabelaAfetados (db: SQLiteDatabase) {
    ...
    fun cria() {
        db.execSQL("CREATE TABLE $NOME_TABELA (${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, $CAMPO_NOME TEXT NOT NULL, $CAMPO_ENDERECO TEXT NOT NULL, $CAMPO_NECESSIDADE TEXT NOT NULL, $CAMPO_TELEMOVEL TEXT NOT NULL, $CAMPO_DESCRICAO_PROBLEMA TEXT NOT NULL, $CAMPO_DATA_NASCIMENTO INTEGER NOT NULL)")
    }
    ...
    companion object {
        ...
        val TODOS_CAMPOS = arrayOf(BaseColumns._ID, CAMPO_NOME, CAMPO_ENDERECO, CAMPO_NECESSIDADE, CAMPO_DATA_NASCIMENTO,CAMPO_TELEMOVEL, CAMPO_DESCRICAO_PROBLEMA)
    }
}